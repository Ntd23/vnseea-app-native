              ...
              {(
                ...
                <TouchableOpacity
                  ...
                  className={`flex-1 items-center justify-center rounded-xl py-3 ${
                    activeTab === key ? 'bg-white shadow-sm' : 'bg-transparent'
                  }`}
                  ...
                  {labels.length === 0 ? (
                    ...
                    labels.map(label => {
                      ...
                      return (
                        <View
                          key={label.id}
                          className="flex-row items-center border-b border-slate-100 px-4 py-3.5 last:border-b-0"
                        >
                          <View
                    ...
                    labels.map(label => (
                      ...
                      >
                        ...
                        <TouchableOpacity
                          ...
                          disabled={isLoading}
                          activeOpacity={0.8}
                          onPress={() => onDelete(label.id).catch(() => undefined)}
                        >
        ...
        {filteredUsers.length === 0 ? (
          ...
          filteredUsers.map(user => {
            ...
            return (
              <TouchableOpacity
                key={user.userId}
                className="flex-row items-center justify-between py-2.5 border-b border-slate-100/50 last:border-b-0"
                activeOpacity={0.8}
                onPress={() => {
                  setSelectedUserIds(prev => {
  ...
  return (
    ...
    >
      <Pressable className="flex-1 justify-center bg-black/40 px-6" onPress={onClose}>
        <Pressable className="rounded-3xl bg-white p-5 shadow-xl" onPress={() => {}}>
