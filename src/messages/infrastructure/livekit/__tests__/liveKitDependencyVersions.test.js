...
describe('LiveKit dependency versions', () => {
  it('wraps LiveKit iOS audio management through the official setupIOSAudioManagement hook', () => {
    ...
    expect(helperSource).toContain('iosVoiceCallAudioActive');
    ...
    expect(helperSource).toContain('if (iosVoiceCallAudioActive)');
    ...
    expect(helperSource).toContain("logLiveKitAudioDebug('ios_voice_call_audio_active_changed'");
