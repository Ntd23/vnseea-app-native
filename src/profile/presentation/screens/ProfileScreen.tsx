...
const PROFILE_COPY: Record<AppLanguage, {
  ...
  vi: {
    userFallback: 'NgÆ°á»i dĂ¹ng',
    dashboard: 'Báº£ng Ä‘iá»u khiá»ƒn',
    addToStory: 'ThĂªm vĂ o tin',
    followed: 'ÄĂ£ theo dĂµi',
    message: 'Nháº¯n tin',
    poke: 'Chá»c',
    requestSent: 'ÄĂ£ gá»­i yĂªu cáº§u',
    sending: 'Äang gá»­i...',
    follow: 'Theo dĂµi',
    stories: 'Tin',
    ...
    details: 'Chi tiáº¿t',
    member: 'ThĂ nh viĂªn',
    vipMember: 'ThĂ nh viĂªn VIP Member',
    worksAt: value => `LĂ m viá»‡c táº¡i ${value}`,
    livesAt: value => `Sá»‘ng táº¡i ${value}`,
    activeNow: 'Äang hoáº¡t Ä‘á»™ng',
    followersText: count => `CĂ³ ${count} ngÆ°á»i theo dĂµi`,
    followingText: count => `Äang theo dĂµi ${count} ngÆ°á»i`,
    pointsText: count => `TĂ­ch lÅ©y ${count} Ä‘iá»ƒm`,
    editPublicDetails: 'Chá»‰nh sá»­a chi tiáº¿t cĂ´ng khai',
    friends: 'Báº¡n bĂ¨',
    findFriends: 'TĂ¬m báº¡n bĂ¨',
    friendFallback: 'Báº¡n bĂ¨',
    seeAll: 'Xem táº¥t cáº£',
    composerPlaceholder: 'Báº¡n Ä‘ang nghÄ© gĂ¬?',
    goLive: 'PhĂ¡t trá»±c tiáº¿p',
    photoVideo: 'áº¢nh/video',
    lifeEvent: 'Sá»± kiá»‡n trong Ä‘á»i',
    posts: 'BĂ i viáº¿t',
    manage: 'Quáº£n lĂ½',
    loadPostsError: 'Lá»—i táº£i bĂ i viáº¿t',
    noPosts: 'ChÆ°a cĂ³ bĂ i viáº¿t nĂ o',
    edit: 'Chá»‰nh sá»­a',
    avatarOptionsTitle: 'TĂ¹y chá»n áº£nh Ä‘áº¡i diá»‡n',
    cancel: 'Há»§y',
    errorTitle: 'Lá»—i',
    reactionError: 'KhĂ´ng thá»ƒ cáº­p nháº­t cáº£m xĂºc. Vui lĂ²ng thá»­ láº¡i.',
    voteError: 'KhĂ´ng thá»ƒ gá»­i phiáº¿u báº§u. Vui lĂ²ng thá»­ láº¡i.',
    connectError: 'KhĂ´ng thá»ƒ gá»­i lá»i má»i káº¿t báº¡n. Vui lĂ²ng thá»­ láº¡i.',
    pokeSuccessTitle: 'ÄĂ£ chá»c',
    pokeSuccessMessage: name => `Báº¡n Ä‘Ă£ chá»c ${name}.`,
    pokeError: 'KhĂ´ng thá»ƒ chá»c ngÆ°á»i dĂ¹ng nĂ y lĂºc nĂ y.',
  },
  en: {
    userFallback: 'User',
    dashboard: 'Dashboard',
...
function formatFormattedDate(date: Date, lang: AppLanguage): string {
  if (lang === 'vi') {
    ...
    return `ÄĂ£ tham gia ${day} Thg ${month}, ${year}`;
  } else {
...
function ProfileScreen() {
  ...
  useEffect(() => {
    ...
    feedRepo.getUserPosts(targetUserId, PROFILE_POST_PAGE_SIZE)
      ...
      .catch(err => {
        ...
        setPostsError(err instanceof Error ? err.message : 'KhĂ´ng táº£i Ä‘Æ°á»£c bĂ i viáº¿t.');
      })
      .finally(() => {
        if (!cancelled) {
          setIsPostsLoading(false);
  ...
  const handleChangeAvatar = async () => {
    try {
      ...
      if (success) {
        ...
        Alert.alert(copy.errorTitle, 'KhĂ´ng thá»ƒ cáº­p nháº­t áº£nh Ä‘áº¡i diá»‡n.');
      }
    } catch (err) {
      console.error(err);
    } finally {
  ...
  const handleChangeCover = async () => {
    try {
      ...
      if (success) {
        ...
        Alert.alert(copy.errorTitle, 'KhĂ´ng thá»ƒ cáº­p nháº­t áº£nh bĂ¬a.');
      }
    } catch (err) {
      console.error(err);
    } finally {
  ...
  const handleCopyUsername = useCallback(async () => {
    ...
    try {
      ...
      Alert.alert(
        language === 'vi' ? 'ThĂ nh cĂ´ng' : 'Success',
        language === 'vi' ? 'ÄĂ£ sao chĂ©p tĂªn ngÆ°á»i dĂ¹ng vĂ o khay nhá»› táº¡m.' : 'Username copied to clipboard.',
      );
    } catch (err) {
      console.error(err);
    }
  ...
  const handleEditProfilePress = useCallback(() => {
    ...
    Alert.alert(
      ...
      language === 'vi' ? 'Chá»n tĂ¡c vá»¥ báº¡n muá»‘n thá»±c hiá»‡n' : 'Select what you want to do',
      [
        {
          text: language === 'vi' ? 'Thay Ä‘á»•i áº£nh bĂ¬a' : 'Change Cover Photo',
          onPress: handleChangeCover,
        },
        {
          text: language === 'vi' ? 'Chá»‰nh sá»­a thĂ´ng tin chi tiáº¿t' : 'Edit Public Details',
      ...
      <View style={profileMainStyles.container}>
        ...
        >
          ...
          <View style={profileMainStyles.profileInfoCard}>
            ...
            <View style={profileMainStyles.statsContainer}>
              ...
              <View style={profileMainStyles.statItem}>
                ...
                <Text style={profileMainStyles.statNumber}>{followerCount}</Text>
                <Text style={profileMainStyles.statLabel}>
                  {language === 'vi' ? 'NgÆ°á»i theo dĂµi' : 'Followers'}
                </Text>
              </View>
              ...
              <View style={profileMainStyles.statItem}>
                ...
                <Text style={profileMainStyles.statLabel}>
                  {language === 'vi' ? 'Äang theo dĂµi' : 'Following'}
                </Text>
              </View>
                ...
                <>
                  ...
                  >
                    ...
                    <Text style={profileMainStyles.storyAddButtonText}>
                      {language === 'vi' ? 'ThĂªm vĂ o tin' : 'Add to story'}
                    </Text>
                  </TouchableOpacity>
                </>
              ) : isFriendProfile ? (
          ...
          {shouldShowStorySection && (
            <View style={profileMainStyles.halfCard} className="mx-4 mt-4">
              <View style={profileMainStyles.cardHeader}>
                ...
                >
                  <Text style={profileMainStyles.cardHeaderAction}>
                    {language === 'vi' ? 'Xem táº¥t cáº£ >' : 'See all >'}
                  </Text>
                </TouchableOpacity>
              </View>
                  ...
                  {isOwnProfile && (
                    <View style={{ width: 95 }}>
                      ...
                      <Text
                        ...
                        numberOfLines={1}
                      >
                        {language === 'vi' ? 'Táº¡o tin má»›i' : 'Create story'}
                      </Text>
                    </View>
                  )}
                  ...
                  {!!userStory && (
                    <View style={{ width: 95 }}>
                      ...
                      <Text style={profileMainStyles.friendName} numberOfLines={1}>
                        {language === 'vi' ? 'Tin cá»§a báº¡n' : 'Your story'}
                      </Text>
          ...
          {/* Details & Friends cards row */}
          <View style={profileMainStyles.cardRow}>
            {/* Chi tiáº¿t (Details) Card */}
            <View style={profileMainStyles.halfCard}>
              <View style={profileMainStyles.cardHeader}>
                <Text style={profileMainStyles.cardTitle}>{copy.details}</Text>
                <TouchableOpacity
                  activeOpacity={0.8}
                  onPress={handleEditProfilePress}
                >
              ...
              <View className="mb-2">
                <View style={profileMainStyles.detailItem}>
                  <User size={14} color="#65676B" />
                  <Text style={profileMainStyles.detailText} numberOfLines={1}>
                    {profile?.pro ? copy.vipMember : copy.member}
                  </Text>
                </View>
                <View style={profileMainStyles.detailItem}>
                  <Clock size={14} color="#65676B" />
                  <Text style={profileMainStyles.detailText} numberOfLines={1}>
                    {profile?.lastSeenText ?? copy.activeNow}
                  </Text>
                </View>
                <View style={profileMainStyles.detailItem}>
                  <Users size={14} color="#65676B" />
                  <Text style={profileMainStyles.detailText} numberOfLines={1}>
                    {followerCount} {language === 'vi' ? 'ngÆ°á»i theo dĂµi' : 'followers'}
                  </Text>
                </View>
                <View style={profileMainStyles.detailItem}>
                  <UserCheck size={14} color="#65676B" />
                  <Text style={profileMainStyles.detailText} numberOfLines={1}>
                    Äang theo {followingCount} ngÆ°á»i
                  </Text>
                </View>
                <View style={profileMainStyles.detailItem}>
                  <Star size={14} color="#65676B" />
                  <Text style={profileMainStyles.detailText} numberOfLines={1}>
                    {Number(profile?.points ?? 0)} Ä‘iá»ƒm thÆ°á»Ÿng
                  </Text>
                </View>
              </View>

              <TouchableOpacity
                style={profileMainStyles.cardButton}
                activeOpacity={0.8}
                onPress={() => isOwnProfile && navigation.navigate(ROUTES.EDIT_PROFILE)}
              >
                <Text style={profileMainStyles.cardButtonText} numberOfLines={1}>
                  Chá»‰nh sá»­a chi tiáº¿t
                </Text>
              </TouchableOpacity>
            </View>

            {/* Báº¡n bĂ¨ (Friends) Card */}
            <View style={profileMainStyles.halfCard}>
              <View style={profileMainStyles.cardHeader}>
                <Text style={profileMainStyles.cardTitle}>{copy.friends}</Text>
                <TouchableOpacity
                  activeOpacity={0.8}
              ...
              <Text style={profileMainStyles.friendsSubtitle}>
                {followerCount} {language === 'vi' ? 'ngÆ°á»i báº¡n' : 'friends'}
              </Text>

              {profileFriends.length > 0 ? (
                <View style={profileMainStyles.friendsRow}>
                  {profileFriends.slice(0, 2).map(friend => (
                    <TouchableOpacity
                      key={String(friend.id)}
                      style={profileMainStyles.friendThumb}
                      activeOpacity={0.85}
                      onPress={() => handleNavigateToProfile(String(friend.id))}
                    >
                      <View style={profileMainStyles.friendImageContainer}>
                        <Image
                          source={{ uri: friend.avatarUrl ?? FALLBACK_AVATAR }}
                          style={profileMainStyles.friendImage}
                          resizeMode="cover"
                        />
                        <View style={profileMainStyles.friendOnlineDot} />
                      </View>
                ...
                <View className="rounded-xl bg-[#F8FAFC] px-2 py-4 flex-1 justify-center items-center">
                  <Text style={{ fontSize: 10, color: '#65676B', textAlign: 'center' }}>
                    {language === 'vi' ? 'ChÆ°a cĂ³ báº¡n bĂ¨' : 'No friends'}
                  </Text>
                </View>
              )}

              <View style={profileMainStyles.dotsContainer}>
                <View style={profileMainStyles.dotActive} />
                <View style={profileMainStyles.dotInactive} />
              </View>
            </View>
          </View>
          ...
          {/* Composer Card */}
          {isOwnProfile && (
            <View style={profileMainStyles.composerCard}>
              <View style={profileMainStyles.composerTop}>
                <View style={profileMainStyles.composerAvatarWrap}>
                  <Image source={{ uri: avatarUrl }} style={profileMainStyles.composerAvatar} />
                  <View style={profileMainStyles.composerOnlineDot} />
                </View>
                <TouchableOpacity
                  style={profileMainStyles.composerInput}
                  activeOpacity={0.85}
                  onPress={() => navigation.navigate(ROUTES.CREATE_POST)}
                >
                  <Text style={profileMainStyles.composerInputText}>
                    {copy.composerPlaceholder}
                  </Text>
                </TouchableOpacity>
              </View>
              <View style={profileMainStyles.composerBottom}>
                <TouchableOpacity
                  style={profileMainStyles.composerActionButton}
                  activeOpacity={0.8}
                  onPress={() => navigation.navigate(ROUTES.CREATE_POST)}
                >
                  <Video size={14} color="#E11D48" fill="#E11D48" />
                  <Text style={[profileMainStyles.composerActionText, { color: '#E11D48' }]}>Live</Text>
                </TouchableOpacity>
                ...
                >
                  ...
                  <Text style={[profileMainStyles.composerActionText, { color: '#16A34A' }]}>áº¢nh/Video</Text>
                </TouchableOpacity>
                ...
                >
                  ...
                  <Text style={[profileMainStyles.composerActionText, { color: '#F59E0B' }]}>Sá»± kiá»‡n Ä‘á»i</Text>
                </TouchableOpacity>
              </View>
            </View>
          )}
          ...
          <View style={profileMainStyles.postsHeader}>
            ...
            >
              ...
              <Text style={profileMainStyles.managePostsText}>
                {language === 'vi' ? 'Quáº£n lĂ½ bĂ i viáº¿t' : 'Manage posts'}
              </Text>
            </TouchableOpacity>
          </View>
