// Description: Presents group post management actions in a WoWonder-style bottom sheet.
...
type GroupPostMenuAction = 'edit' | 'delete' | 'comments' | 'pin';

interface GroupPostMenuActionSheetProps {
  visible: boolean;
  post: FeedPost | null;
  onClose: () => void;
...
export function GroupPostMenuActionSheet({
  visible,
  post,
  onClose,
  onEdit,
  ...
  onToggleComments,
  onPin,
}: GroupPostMenuActionSheetProps) {
  const [loadingAction, setLoadingAction] = useState<GroupPostMenuAction | null>(null);
  ...
  return (
    <Modal transparent animationType="fade" onRequestClose={onClose}>
      ...
      <View className="absolute bottom-0 left-0 right-0 rounded-t-2xl bg-white px-4 pb-6 pt-4 shadow-lg">
        ...
        <MenuAction
          title="Tắt nhận xét"
          description="Cho phép hoặc không cho phép các thành viên bình luận về bài đăng này."
        ...
        <MenuAction
          title="Ghim bài đăng"
          description="Ghim bài đăng này lên đầu nhóm."
