...
define('T_MESSAGE_PINS', 'Wo_MessagePins');
...
define('T_USER_TAG_LABELS','user_tag_labels');
define('T_USER_TAG_ASSIGNMENTS','user_tag_assignments');
define('PAYMENT','payments');
define('SEPAY_TRANSACTION','sepay_transactions');
